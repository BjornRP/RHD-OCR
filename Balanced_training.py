...
###############################################################################
###### Training with the balanced 3000, validating with the normal 1000 #######
###############################################################################
# =============================================================================
# X_train, y_train = read_and_process_image(train_imgs, False)
# X_val, y_val = read_and_process_image(validate_imgs, False)
# 
# del train_imgs, validate_imgs
# gc.collect()
# 
...
# print('Shape of labels are:', y_train.shape)
# 
# #Reshape X for later use in Keras, current shape is (XXXX, 100, 100), we want it to be (XXXX, 100, 100, 1)
# X_train = np.expand_dims(X_train, axis=-1)
#     
# print('Shape of training images after reshaping are:', X_train.shape)
# 
...
###############################################################################
###### Training with the balanced 3000, validating with the balanced 3000 #####
###############################################################################
